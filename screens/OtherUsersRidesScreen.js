...
const OtherUsersRidesScreen = props => {
  ...
  return (
    ...
    >
      <SimpleStyleScrollView
        ...
        style={StyleSheet.applyWidth(
          { paddingLeft: 24, paddingRight: 24, paddingTop: 32 },
          dimensions.width
        )}
      >
          ...
          {({ loading, error, data, refetchGetEvents$DescendingOrder$ }) => {
            ...
            return (
              <>
                ...
                <>
                  {hasData(
                    filterEventsByUserId(fetchData, Constants['otherUserId'])
                  ) ? null : (
                    <View
                      style={StyleSheet.applyWidth(
                        {
...
export default withTheme(OtherUsersRidesScreen);
